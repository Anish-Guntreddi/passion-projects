...
# GoogleTest itself.
function(pebbledb_enable_sanitizers target_name)
  set(sanitizers "")

  if(PEBBLEDB_ENABLE_ASAN)
    list(APPEND sanitizers "address")
  endif()

  if(PEBBLEDB_ENABLE_UBSAN)
    list(APPEND sanitizers "undefined")
  endif()

  if(PEBBLEDB_ENABLE_TSAN)
    if(PEBBLEDB_ENABLE_ASAN)
      message(FATAL_ERROR "PEBBLEDB_ENABLE_TSAN cannot be combined with PEBBLEDB_ENABLE_ASAN")
    endif()
